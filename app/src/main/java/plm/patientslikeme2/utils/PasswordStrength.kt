...
enum class PasswordStrength(var msg: Int, var color: Int) {
    ...
    STRONG(R.string.strong, MyApplication.instance.getColor(R.color.data_positive_moderate)),
    VERY_STRONG(R.string.strong, MyApplication.instance.getColor(R.color.data_positive_major));
