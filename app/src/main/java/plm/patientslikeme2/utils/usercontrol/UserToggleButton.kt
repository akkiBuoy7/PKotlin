...
abstract class UserToggleButton : LinearLayout {
     ...
     */
    private fun setPressedColors(
        @ColorInt colorPressedText: Int,
        @ColorInt colorPressedBackground: Int
    ) {
     ...
     */
    private fun setNotPressedColors(colorNotPressedText: Int, colorNotPressedBackground: Int) {
